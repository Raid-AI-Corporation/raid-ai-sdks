...
export type DocumentDataStatus = Schemas["DocumentDataStatus"];
export type DocumentExtractionSkipReason = Schemas["DocumentExtractionSkipReason"];
export type DocumentExtractionStatus = Schemas["DocumentExtractionStatus"];
export type DocumentExtraction = Schemas["DocumentExtraction"];
export type DocumentExtractionFieldCheck = Schemas["DocumentExtractionFieldCheck"];
export type DocumentExtractionFieldOverride = Schemas["DocumentExtractionFieldOverride"];
export type DocumentExtractionPage = Schemas["DocumentExtractionPage"];
